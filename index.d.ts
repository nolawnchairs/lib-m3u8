...
export declare class Manifest implements IM3u8Producer {
	readonly meta: IM3u8Line[];
	readonly variants: IM3u8Variant[];
	constructor(meta: IM3u8Line[], variants: IM3u8Variant[]);
	/**
...
export declare type VariantModifier = (variant: IM3u8Variant) => IM3u8Variant;
export declare type VariantPredicate = (variant: IM3u8Variant) => boolean;
/**
